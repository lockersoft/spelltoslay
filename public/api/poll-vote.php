...
if (!is_int($pollId)) {
    slay_json(400, ['error' => 'pollId must be an integer']);
    return;
}

// Validate optionIndex is an integer.
if (!is_int($optionIndex) || $optionIndex < 0) {
    slay_json(400, ['error' => 'optionIndex must be a non-negative integer']);
    return;
}
