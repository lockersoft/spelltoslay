...
class ScoreTest extends TestCase
{
    ...
    {
        sts_invoke('score.php', 'POST', [], ['name'=>'A','score'=>500,'wave'=>5,'duration'=>60]);
        sts_invoke('score.php', 'POST', [], ['name'=>'B','score'=>900,'wave'=>9,'duration'=>120]);
    ...
    {
        sts_invoke('score.php', 'POST', [], ['name'=>'A','score'=>1,'wave'=>1,'duration'=>1]);
        [$status, , $json] = sts_invoke('score.php', 'POST', [], [
